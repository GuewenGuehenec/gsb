...
public class ConnexionMySql { // DAO = Data Access Object
	 ...
	 * @return 
	 */
	public static com.mysql.jdbc.Connection connecterBd(){
		//connexion à la base de donnée à partir de jdbc
		String url = "jdbc:mysql://192.173.1.21:3306/gsbv5_v5"; // url : chaine de connexion
		// try permet d'essayer de lancer la connexion
		try {Class.forName("com.mysql.jdbc.Driver"); 
			cnx = DriverManager.getConnection(url,"gsbuser","password"); 
		} 
		...
		return (com.mysql.jdbc.Connection) cnx; 
